...
# 📖 TO-DO LIST <a name="TO-DO LIST-site"></a>

**TO-DO LIST** This is a simple single app built with HTML, CSS and javascript, it enables users to add, check, and uncheck their to-do list.
...
-add task
-remove task
-displays tasks dynamically from javascript.
...
```
git clone git@github.com:ntimanu/To-do-list.git
```
